...
class _FavoritesPageState extends State<FavoritesPage>
  ...
  void _onFavoriteChanged() {
    ...
    if (change != null) {
      if (change.isAdded) {
        // Recharger la liste pour inclure le nouveau favori
        _loadFavorites();
      } else {
        // Supprimer de la liste locale
        setState(() {
          _favorites.removeWhere((productMap) => productMap['productId'] == change.productId);
        });
      }
    }
  }
  ...
  Future<void> _removeFavorite(String favoriteDocId, int index) async {
    try {
      ...
      // Capture productId before mutating the list
      final productId = _favorites[index]['productId'] as String? ?? favoriteDocId;
      ...
      // Broadcast to every active _ProductCardState via the global notifier
      favoriteChangedNotifier.value = FavoriteChange(productId: productId, isAdded: false);
      favoriteRemovedNotifier.value = favoriteDocId; // kept for backward compat
            ...
            Container(
              ...
              child: Column(children: [
                Container(
                    ...
                    child: const Icon(Icons.heart_broken_rounded, color: Colors.white, size: 36)),
            ...
            Padding(
              ...
              child: Column(children: [
                ...
                Container(
                    ...
                    child: Row(children: [
                      const Icon(Icons.shopping_bag_rounded, size: 15, color: Color(0xFFEF4444)),
                      const SizedBox(width: 8),
    ...
    return Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
      Container(width: 64, height: 64,
          decoration: BoxDecoration(
              ...
              boxShadow: [BoxShadow(color: const Color(0xFF7C3AED).withOpacity(0.3),
        ...
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          Container(
              ...
              decoration: BoxDecoration(
                  gradient: const LinearGradient(
                      ...
                      begin: Alignment.topLeft, end: Alignment.bottomRight),
                  shape: BoxShape.circle,
                  boxShadow: [BoxShadow(color: Colors.red.withOpacity(0.12),
                      blurRadius: 24, offset: const Offset(0, 8))]),
              child: Icon(Icons.favorite_border_rounded,
                  size: isMobile ? 52 : 62, color: const Color(0xFFEF4444).withOpacity(0.7))),
          const SizedBox(height: 28),
          Text(_t('favorites_empty_title'),
              style: TextStyle(fontSize: isMobile ? 20 : 22, fontWeight: FontWeight.w800,
                  color: const Color(0xFF1E293B)), textAlign: TextAlign.center),
          const SizedBox(height: 10),
          Text(_t('favorites_empty_desc'),
              style: TextStyle(fontSize: isMobile ? 14 : 15, color: Colors.grey.shade500, height: 1.6),
              textAlign: TextAlign.center),
          ...
          Container(
              decoration: BoxDecoration(
                  ...
                  boxShadow: [BoxShadow(color: const Color(0xFF7C3AED).withOpacity(0.4),
    ...
    return RefreshIndicator(
      ...
      child: GridView.builder(
        padding: EdgeInsets.fromLTRB(
            isMobile ? 14 : 18, 20, isMobile ? 14 : 18, 24),
        ...
        itemBuilder: (context, index) {
          ...
          return AnimatedBuilder(
              ...
              child: _buildProductCard(_favorites[index], index, isMobile, isTablet));
        },
      ),
    );
  }
          ...
          child: Padding(
              ...
              child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                Container(padding: const EdgeInsets.all(10),
                    ...
                    child: const Icon(Icons.heart_broken_rounded, color: Colors.white, size: 24)),
                const SizedBox(height: 6),
                const Text('Retirer', style: TextStyle(color: Colors.white,
                    fontSize: 11, fontWeight: FontWeight.w700)),
              ]))),
      confirmDismiss: (direction) async =>
      await _showRemoveDialog(favoriteDocId, index, name),
      onDismissed: (_) {},
      child: GestureDetector(
        onTap: () {
          final p = Product(
            id: productId, name: product['name'] as String? ?? '',
            ...
            reward: product['reward'] != null
                ? Reward.fromMap(product['reward'] as Map<String, dynamic>) : null,
        ...
        child: Container(
          decoration: BoxDecoration(color: Colors.white,
              ...
              boxShadow: [
                ...
                BoxShadow(color: const Color(0xFF7C3AED).withOpacity(0.04), blurRadius: 6, offset: const Offset(0, 2)),
              ]),
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Expanded(flex: 62, child: Stack(children: [
              ClipRRect(
                  borderRadius: const BorderRadius.vertical(top: Radius.circular(22)),
                  child: SizedBox(width: double.infinity, height: double.infinity,
                      child: images != null && images.isNotEmpty
                          ? Image.memory(base64Decode(images.first.toString()), fit: BoxFit.cover,
              ...
              Positioned(top: 10, right: 10,
                  child: GestureDetector(
                      onTap: () => _showRemoveDialog(favoriteDocId, index, name),
              ...
              Positioned(bottom: 10, left: 10, right: 10,
                  child: di.isActive
                    ...
                    Container(
                        ...
                        child: Text(currency.formatPrice(di.originalPrice),
                    ...
                    Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            boxShadow: [BoxShadow(
                                ...
                                blurRadius: 8, offset: const Offset(0, 2))]),
                        child: Text(currency.formatPrice(di.effectivePrice),
                            style: TextStyle(color: Colors.white,
                                fontSize: isMobile ? 12 : 13, fontWeight: FontWeight.w800))),
                  ])
                      : Container(
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                      ...
                      children: [
                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          Row(children: [
                            Icon(Icons.swipe_left_rounded, size: 12, color: Colors.grey.shade400),
                            const SizedBox(width: 3),
                            Text(_t('swipe_to_remove'), style: TextStyle(fontSize: 10,
  ...
  Widget _imagePlaceholder() => Container(color: const Color(0xFFF1F5F9),
      child: Center(child: Icon(Icons.image_outlined, color: Colors.grey.shade300, size: 42)));
}
...
class _DiscountInfo {
  ...
  const _DiscountInfo({
    required this.originalPrice, required this.effectivePrice,
    required this.isActive, this.discountPercent,
  });
}