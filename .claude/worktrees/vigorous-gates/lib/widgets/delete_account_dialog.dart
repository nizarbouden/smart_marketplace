...
class _DeleteAccountDialogState extends State<DeleteAccountDialog> {
  ...
  bool get _canSubmit {
    ...
    final otherOk   = !_showOtherField || _otherReasonController.text.trim().isNotEmpty;
  ...
  Future<void> _deactivateAccount() async {
    ...
    try {
      ...
      // 2. Désactiver le compte Firestore
      ...
      try {
        ...
        print('⚠️ Erreur email: $emailError');
        // Ne pas bloquer la déactivation si l'email échoue
      }

      // ✅ FIX PERMISSION-DENIED :
      // Naviguer AVANT signOut pour que tous les streams Firestore
      // soient disposés (les widgets sont unmountés) avant la déconnexion
      if (mounted) Navigator.of(context).pop(); // ferme le dialog

      // ✅ Naviguer vers /login en premier — dispose tous les listeners
      navigationService.navigatorKey.currentState
          ?.pushNamedAndRemoveUntil('/login', (route) => false);

      // ✅ Attendre que la navigation soit terminée et les widgets disposés
      await Future.delayed(const Duration(milliseconds: 400));

      // 4. Déconnecter APRÈS la navigation
                ...
                Container(
                  ...
                  child: _isLoading
                    ...
                    child: Column(
                      ...
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        Text(AppLocalizations.get('delete_account_dialog_title'),
                            style: const TextStyle(
                                fontSize: 22, fontWeight: FontWeight.bold,
                                color: Color(0xFFDC2626), letterSpacing: 0.5)),
                        const SizedBox(height: 8),
                        Text(AppLocalizations.get('delete_account_dialog_subtitle'),
                            style: const TextStyle(
                                fontSize: 14, color: Color(0xFF64748B), height: 1.4)),
                        const SizedBox(height: 20),

                        // ── Raisons ─────────────────────────────
                        Text(AppLocalizations.get('delete_account_reason_label'),
                            style: const TextStyle(
                              ...
                              InkWell(
                                ...
                                child: Container(
                                  ...
                                  child: Row(children: [
                                    ...
                                    Expanded(child: Text(_reasons[i],
                                        style: TextStyle(
                                          fontSize:   14,
                          ...
                          child: Column(
                            ...
                            children: [
                              Row(children: [
                                ...
                                Expanded(child: Text(
                                    AppLocalizations.get('delete_confirm_instruction'),
                                    style: const TextStyle(
                              ...
                              RichText(text: TextSpan(
                                ...
                                children: [
                                  TextSpan(text: AppLocalizations.get(
                              ...
                              TextField(
                                ...
                                _confirmValid = v.trim() == confirmWord),
                                style: const TextStyle(
                                    fontSize: 14, fontWeight: FontWeight.w600,
                                    letterSpacing: 1, color: Color(0xFF1E293B)),
                                decoration: InputDecoration(
                            ...
                            child: SizedBox(
                              ...
                              child: AnimatedOpacity(
                                ...
                                child: ElevatedButton(
                                  onPressed: _canSubmit ? _deactivateAccount : null,
