...
class _ProductDetailPageState extends State<ProductDetailPage>
    ...
    return Scaffold(
      ...
      body: FadeTransition(
        ...
        child: Stack(children: [
          // ✅ RefreshIndicator pour recharger au pull-to-refresh
          RefreshIndicator(
            onRefresh: () async {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 20),
                      // ✅ Bannière visibilité avec widget isolé
          ...
          child: Container(
            ...
            child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Expanded(child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(_t('shipping_no_address_title'),
                        style: const TextStyle(fontSize: 14,
                            fontWeight: FontWeight.bold,
                            color: Color(0xFF1E40AF))),
                    const SizedBox(height: 4),
                    Text(_t('shipping_no_address_desc'),
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Row(mainAxisSize: MainAxisSize.min, children: [
                          ...
                          Text(_t('shipping_add_address_btn'),
  ...
  Widget _buildImageCarousel(Product product) {
    ...
    return SizedBox(
      ...
      child: Stack(children: [
        ...
        // Gradient top
        Positioned(
          top: 0, left: 0, right: 0, height: topPad + 90,
          child: Container(
            decoration: BoxDecoration(
        ...
        // ✅ Badge remise — widget isolé, ne rebuild pas la page
      ...
      child: Row(children: [
            ...
            children: [
              ...
              Row(crossAxisAlignment: CrossAxisAlignment.end, children: [
                ...
                const Padding(
                  ...
                  child: Text('TND', style: TextStyle(fontSize: 14,
        ...
        Container(
          ...
          child: Column(children: [
            ...
            Text('TND', style: TextStyle(fontSize: 9,
                color: Colors.white.withOpacity(0.8),
                fontWeight: FontWeight.w600)),
          ]),
        ),
  ...
  Widget _buildStockProgressBar(Product product) {
    ...
    final stockMax = (product.initialStock != null &&
  ...
  // ══════════════════════════════════════════════════════════════════
  // ✅ BANNIÈRE VISIBILITÉ — utilise le widget isolé _CountdownText
  // ══════════════════════════════════════════════════════════════════
      ...
      child: Row(children: [
        Container(
          ...
          decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(10)),
          child: Icon(urgent
              ? Icons.timer_off_rounded : Icons.schedule_rounded,
        ...
        Expanded(child: Column(
          ...
          Text(_t('detail_visible_for'),
              style: TextStyle(fontSize: 11,
                  ...
                  fontWeight: FontWeight.w600)),
          const SizedBox(height: 2),
          // ✅ Seul ce widget se rebuild chaque seconde
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        _QuantityButton(
          ...
          onTap: isOut || _quantity <= 1
              ? null : () => setState(() => _quantity--),
        ),
        Padding(
        ...
        _QuantityButton(
          ...
          onTap: isOut || _quantity >= product.stock
              ? null : () => setState(() => _quantity++),
        ),
      ]),
    );
  ...
  Widget _buildDescription(Product product) {
    ...
    return Container(
      ...
      child: Text(product.description,
          style: const TextStyle(fontSize: 14,
              color: Color(0xFF475569), height: 1.75)),
    );
  }
  ...
  Widget _buildRewardSection(Product product) {
    ...
    return Container(
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(22),
        boxShadow: [
          BoxShadow(color: const Color(0xFFF59E0B).withOpacity(0.18),
                      ...
                      Container(
                        ...
                        child: ClipRRect(
                          ...
                          child: rewardImageBytes != null
                              ...
                              child: Image.memory(rewardImageBytes,
                                  fit: BoxFit.contain,
                                  width: double.infinity))
                              : AspectRatio(aspectRatio: 4 / 3,
                              child: Container(
                          ...
                          child: Column(
                              ...
                              children: [
                                Row(children: [
                                  ...
                                  Expanded(child: Text(
                                      _t('detail_reward_draw_title'),
                                      style: const TextStyle(fontSize: 14,
                                          fontWeight: FontWeight.w800,
                                          color: Color(0xFF92400E)))),
                                ]),
                                const SizedBox(height: 14),
                                _buildDrawStep('1', _t('detail_reward_step1'),
                                    Icons.shopping_cart_rounded),
                                const SizedBox(height: 10),
                                _buildDrawStep('2', _t('detail_reward_step2'),
                                    Icons.how_to_reg_rounded),
                                const SizedBox(height: 10),
                                _buildDrawStep('3', _t('detail_reward_step3'),
      ...
      child: Column(children: [
        _InfoTile(
          ...
          value: product.status == 'approved'
              ? _t('detail_status_approved') : product.status,
        ),
          ...
          child: GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(16),
                border: Border.all(color: _isFavorite
...
// ══════════════════════════════════════════════════════════════════
// ✅ WIDGET ISOLÉ — Countdown texte (visibilité bannière)
//    setState ne rebuild QUE ce widget, pas la page entière
// ══════════════════════════════════════════════════════════════════
...
class _CountdownTextState extends State<_CountdownText> {
  ...
  Widget build(BuildContext context) {
    ...
    final color = _urgent
        ? const Color(0xFF7C3AED) : const Color(0xFF0EA5E9);
    return Text(_label, style: TextStyle(
        fontSize: 16, fontWeight: FontWeight.w900, color: color));
  }
}

// ══════════════════════════════════════════════════════════════════
// ✅ WIDGET ISOLÉ — Badge remise + countdown sur l'image
//    setState ne rebuild QUE ce widget, pas la page entière
// ══════════════════════════════════════════════════════════════════
...
class _DiscountBadgeState extends State<_DiscountBadge>
  ...
  void initState() {
    ...
    _pulse = AnimationController(
      ...
      ..repeat(reverse: true);
    _anim = Tween<double>(begin: 1.0, end: 1.03)
        ...
        if (_label.isNotEmpty) ...[
          ...
          AnimatedBuilder(
            ...
            builder: (_, child) => Transform.scale(
                scale: _urgent ? _anim.value : 1.0, child: child),
            child: Container(
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        child: Icon(icon, size: 19,
            color: enabled
                ? const Color(0xFF16A34A) : Colors.grey.shade400),
      ),
    );
  }
}
