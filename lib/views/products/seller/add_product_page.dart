  ...
  class _AddProductPageState extends State<AddProductPage>
    ...
    // ✅ Shipping — géré entièrement dans le widget dédié
    ...
    // ✅ Validation shipping : poids + société + au moins 1 zone activée
    ...
    void _populateExisting() {
      ...
      // ✅ Shipping — lecture depuis le nouveau format ou legacy
    ...
    Future<void> _save() async {
      ...
      try {
        ...
        // ── Données communes (sans FieldValue.delete) ──────────────
        ...
        if (_isEditing) {
          // ✅ update : on peut utiliser FieldValue.delete() pour nettoyer le legacy
          ...
          // ✅ add : pas de FieldValue.delete(), on ajoute les champs manquants
          data['createdAt']    = Timestamp.now();
          data['initialStock'] = int.parse(_stockCtrl.text.trim());
          // On retire les valeurs null éventuelles avant l'insertion
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // ✅ Erreur shipping si soumis sans config complète
                        if (_shippingError)
                          Padding(
        ...
        return Padding(
          ...
          child: Row(children: [
            Icon(f['icon'] as IconData, size: 18,
                color: isMissing
                    ? const Color(0xFFEF4444) : const Color(0xFF16A34A)),
            ...
            Icon(isMissing
                ? Icons.close_rounded : Icons.check_circle_rounded, size: 18,
                color: isMissing
                    ? const Color(0xFFEF4444) : const Color(0xFF16A34A)),
          ]),
        );
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                      color: const Color(0xFF3B82F6).withOpacity(0.3), width: 2),
                  boxShadow: [BoxShadow(
              ...
              Container(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      ...
                      const SizedBox(height: 14),
                      _buildAddressInfoRow(Icons.local_shipping_rounded,
                          _t('add_product_address_reason_1')),
                      const SizedBox(height: 10),
                      _buildAddressInfoRow(Icons.verified_rounded,
                          _t('add_product_address_reason_2')),
                      const SizedBox(height: 10),
                      _buildAddressInfoRow(Icons.receipt_long_rounded,
                          _t('add_product_address_reason_3')),
                    ]),
              ),
              const SizedBox(height: 32),
              SizedBox(
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(14),
              border: Border.all(
                  color: const Color(0xFF16A34A).withOpacity(0.35), width: 1.5),
            ),
      ...
      return Column(children: [
        ...
        Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Expanded(child: _buildValidatedField(
            ctrl: _priceCtrl, label: _t('seller_product_price'),
            icon: Icons.sell_rounded, required: true,
          ...
          child: Container(
            ...
            child: Row(children: [
              ...
              Icon(Icons.keyboard_arrow_down_rounded,
                  color: _categoryError
                      ? const Color(0xFFEF4444) : Colors.grey[400]),
            ]),
          ),
        ),
        if (_categoryError)
                    ...
                    child: Container(
                      ...
                      child: Row(children: [
                        Icon(Icons.calendar_today_rounded,
                            color: _hiddenAfterAt != null
                                ? const Color(0xFFF97316) : Colors.grey[400],
                            size: 18),
                        const SizedBox(width: 10),
                        Expanded(child: Text(
                            _hiddenAfterAt != null
                                  ...
                                  children: [
                                    Text(_t('add_product_new_price'),
                                        style: const TextStyle(
                                            ...
                                            color: Color(0xFF94A3B8))),
                                    Text(
                                        '${(origPrice * (1 - pct / 100)).toStringAsFixed(2)} \$',
                                        style: const TextStyle(fontSize: 16,
    ...
    Widget _rewardImageHint({bool hasError = false}) {
      return Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        Icon(Icons.add_photo_alternate_outlined,
            color: hasError
                ? const Color(0xFFEF4444) : const Color(0xFFFBBF24), size: 32),
      ...
      return SizedBox(
        ...
        child: ElevatedButton(
          ...
          child: _isSaving
            ...
            const SizedBox(width: 8),
            Text(_isEditing
                ? _t('seller_save_changes') : _t('add_product_save'),
                style: const TextStyle(
