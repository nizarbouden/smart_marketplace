...
class AddressFormWidget extends StatefulWidget {
  ...
  // ✅ Cache le champ "nom de contact" en mode vendeur
  ...
  const AddressFormWidget({
    ...
    this.hideContactName = false, // ✅ false par défaut → comportement original inchangé
  });
...
class _AddressFormWidgetState extends State<AddressFormWidget> {
  ...
  Widget _buildPersonalInfoSection() {
    // ✅ Si hideContactName=true ET qu'il n'y a que le téléphone → titre allégé
    final sectionTitle = widget.hideContactName
        ? AppLocalizations.get('addr_phone_section') // "Téléphone" / "Phone" / "الهاتف"
        : AppLocalizations.get('addr_personal_info_section');
    ...
    return Column(
      ...
      children: [
        ...
        // ✅ Nom du contact — caché si hideContactName = true
        if (!widget.hideContactName) ...[
          TextFormField(
            controller: widget.contactNameController,
            decoration: _fieldDecoration(
                AppLocalizations.get('addr_contact_name_hint'), Icons.person),
            validator: (v) => (v == null || v.isEmpty)
                ? AppLocalizations.get('addr_contact_name_error')
                : null,
          ),
        ...
        // Code pays + Téléphone (toujours visible)
        Row(children: [
          SizedBox(
          ...
          Expanded(
            child: TextFormField(
              ...
              decoration: _fieldDecoration(
                  AppLocalizations.get('addr_phone_hint'), Icons.phone),
              validator: (v) {
                if (v == null || v.isEmpty)
                  return AppLocalizations.get('addr_phone_error_required');
                if (v.length < 8)
                  return AppLocalizations.get('addr_phone_error_invalid');
                return null;
              },
            ),
          ),
    ...
    return Column(
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: _fieldDecoration(
              AppLocalizations.get('addr_street_hint'), Icons.home),
          validator: (v) => (v == null || v.isEmpty)
              ? AppLocalizations.get('addr_street_error')
              : null,
        ),
        SizedBox(height: _fieldGap),
        ...
        TextFormField(
          ...
          decoration: _fieldDecoration(
              AppLocalizations.get('addr_complement_hint'), Icons.apartment),
        ),
        SizedBox(height: _fieldGap),
        ...
        TextFormField(
          ...
          decoration: _fieldDecoration(
              AppLocalizations.get('addr_province_hint'), Icons.map),
          validator: (v) => (v == null || v.isEmpty)
              ? AppLocalizations.get('addr_province_error')
              : null,
        ),
        SizedBox(height: _fieldGap),
        ...
        TextFormField(
          ...
          decoration: _fieldDecoration(
              AppLocalizations.get('addr_city_hint'), Icons.location_city),
          validator: (v) => (v == null || v.isEmpty)
              ? AppLocalizations.get('addr_city_error')
              : null,
        ),
        SizedBox(height: _fieldGap),
        ...
        TextFormField(
          ...
          inputFormatters: [FilteringTextInputFormatter.digitsOnly],
          decoration: _fieldDecoration(
              AppLocalizations.get('addr_postal_hint'), Icons.mail),
          validator: (v) => (v == null || v.isEmpty)
              ? AppLocalizations.get('addr_postal_error')
              : null,
        ),
      ],
    );
