...
class _DeleteAccountDialogState extends State<DeleteAccountDialog> {
  ...
  Future<void> _deactivateAccount() async {
    ...
    try {
      ...
      try {
        ...
        print(
            '⚠️ Erreur lors de l\'envoi de l\'email de réactivation: $emailError');
      }
  ...
  Widget build(BuildContext context) {
    ...
    return Dialog(
      insetPadding:
      const EdgeInsets.symmetric(horizontal: 20, vertical: 24), // ✅ réduit vertical
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(24)),
      elevation: 20,
      child: PopScope(
        canPop: !_isLoading,
        child: SingleChildScrollView( // ✅ scroll global quand clavier ouvert
          child: Container(
            ...
            child: Column(
              ...
              children: [
                // ── Icône header ────────────────────────────────
                Padding(
                  padding: const EdgeInsets.all(20), // ✅ réduit de 28 → 20
                  child: Container(
                    width: 60,  // ✅ réduit de 70 → 60
                    height: 60, // ✅ réduit de 70 → 60
                    decoration: BoxDecoration(
                    ...
                    child: const Icon(Icons.person_remove_rounded,
                        color: Colors.white, size: 28), // ✅ réduit de 32 → 28
                  ),
                ),
                ...
                Container(
                  ...
                  // ✅ Suppression de constraints BoxConstraints(maxHeight) — cause du bug
